...
while True:
    ...
    olderZ = oldZAccRawValue
    olderX = oldXAccRawValue
    olderY = oldYAccRawValue
...
#    if prev_ACCy < 0 and AccYangle > 0:
#        print("Upward Lift")
...
#    if (oldZAccRawValue - olderZ > 800 and oldZAccRawValue > 0) and (oldYAccRawValue - olderY < -100):
#        print("Upward Lift")
...
#    if (olderX > 0 and oldXAccRawValue < 0) and (olderY > 0 and oldYAccRawValue < 0):
#        print("Upward Lift")

#    if (((ACCz - oldZAccRawValue) <= -750) and (abs(ACCx - oldXAccRawValue) <= 1000)):
#        print("Upward Lift")
    ...
    if 0:                       #Change to '0' to stop showing the angles from the accelerometer
        outputString += "#  AX %5.2f AY %5.2f ACCX RAW %5.2f ACCY RAW %5.2f ACCZ RAW %5.2f #  " % (AccXangle, AccYangle, oldXAccRawValue, oldYAccRawValue, oldZAccRawValue)

    if 0:                       #Change to '0' to stop  showing the angles from the gyro
        outputString +="\t# GX %5.2f  GY %5.2f  GZ %5.2f # " % (gyroXangle,gyroYangle,gyroZangle)
